...
from proyectos.import_views import (
    cancelar_importacion,
    confirmar_importacion,
    descargar_plantilla_programacion,
    historial_importaciones,
    restaurar_importacion,
    subir_programacion_segura,
)
...
urlpatterns = [
    ...
    path('importaciones/confirmar/', confirmar_importacion, name='confirmar_importacion'),
    path('importaciones/cancelar/', cancelar_importacion, name='cancelar_importacion'),
    path('plantilla-programacion.xlsx', descargar_plantilla_programacion, name='descargar_plantilla_programacion'),
